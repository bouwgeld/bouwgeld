...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BouwGeld " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bouwgeld.org", "seed.bouwgeld.org"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{0x2552e140, 0xab8e63a7, 0xe835c780, 0xf60d3eb2,  };
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BouwGeld is probably already running."), addrBind.ToString().c_str());
        else
